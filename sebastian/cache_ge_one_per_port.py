...
def get_points():
    ...
    locations_per_request = 70
    max_number_per_port = 1
    ...
    for port in collect_info :
        ...
        try:
            ...
            current_number_at_port = 0
            while (request_count < max_request_count and location_count < max_location_count and current_point < point_count and current_number_at_port < max_number_per_port) :
                current_number_at_port += 1
                ...
                for result in resultTags:
                    ...
                    collect_insert, collect_count = collectDBhandle.query(collect_query)
