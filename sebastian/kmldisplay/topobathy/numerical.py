...
def buildKML(ge_key=""):
        ...
        # Link to Google Elevation Data
        kml += '<NetworkLink id="GoogleTopoBathyLink">\n'
        kml += '<name>Google 30 Sec Elevation Data</name>\n'
        kml += '<visibility>0</visibility>\n'
        kml += '<open>0</open>\n'
        kml += '<styleUrl>%s/kml_styles.py#infoNoIcon</styleUrl>' % (BASE_URL,)
        kml += '<description>Data derived from Google\'s Elevation Data Web Service.</description>\n'
        kml += '<Link>\n'
        kml += '<href>%s/kmldisplay/topobathy/google30sec.py</href>\n' % (BASE_URL,)
        kml += '<viewRefreshMode>onStop</viewRefreshMode>\n'
        kml += '<viewRefreshTime>3</viewRefreshTime>\n'
        kml += '<viewBoundScale>1.2</viewBoundScale>\n'
        kml += '<httpQuery>GE_KEY=%s</httpQuery>' % (ge_key,)
        ...
        # Link to Google Elevation Data
        kml += '<NetworkLink id="GoogleTopoBathyLink">\n'
        kml += '<name>Google Point 3 Sec Elevation Data</name>\n'
        kml += '<visibility>0</visibility>\n'
        kml += '<open>0</open>\n'
        kml += '<styleUrl>%s/kml_styles.py#infoNoIcon</styleUrl>' % (BASE_URL,)
        kml += '<description>Data derived from Google\'s Elevation Data Web Service.</description>\n'
        kml += '<Link>\n'
        kml += '<href>%s/kmldisplay/topobathy/googlep3sec.py</href>\n' % (BASE_URL,)
        kml += '<viewRefreshMode>onStop</viewRefreshMode>\n'
        kml += '<viewRefreshTime>3</viewRefreshTime>\n'
        kml += '<viewBoundScale>1.2</viewBoundScale>\n'
        kml += '<httpQuery>GE_KEY=%s</httpQuery>' % (ge_key,)
        ...
        # Link to Google Elevation Data
        kml += '<NetworkLink id="GoogleTopoBathyLink">\n'
        kml += '<name>Google 3 Sec Elevation Data</name>\n'
        kml += '<visibility>0</visibility>\n'
        kml += '<open>0</open>\n'
        kml += '<styleUrl>%s/kml_styles.py#infoNoIcon</styleUrl>' % (BASE_URL,)
        kml += '<description>Data derived from Google\'s Elevation Data Web Service.</description>\n'
        kml += '<Link>\n'
        kml += '<href>%s/kmldisplay/topobathy/google3sec.py</href>\n' % (BASE_URL,)
        kml += '<viewRefreshMode>onStop</viewRefreshMode>\n'
        kml += '<viewRefreshTime>3</viewRefreshTime>\n'
        kml += '<viewBoundScale>1.2</viewBoundScale>\n'
        kml += '<httpQuery>GE_KEY=%s</httpQuery>' % (ge_key,)
